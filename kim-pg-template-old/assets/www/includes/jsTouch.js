...
var jsTouch = {
	...
	overlayPage: function(url, params, callBack) {
		...
		$.get(url, {}, function (data) {
			...
			/*
			Added by Kim
			For Modal tooth number
			Matching the tooth number
			*/
		 var objGroup = [
		  { "fdiName": "maxillary central incisor", "code": "11,21,51,61" },
		  { "fdiName": "mandibular central incisor", "code": "41,31,81,71" },
		  { "fdiName": "maxillary lateral incisor", "code": "12,22,52,62" },
		  { "fdiName": "mandibular lateral incisor", "code": "42,32,82,72" },
		  { "fdiName": "maxillary canine", "code": "13,23,53,63" },
		  { "fdiName": "mandibular canine", "code": "43,33,83,73" },
		  { "fdiName": "maxillary first premolar", "code": "14,24" },
		  { "fdiName": "mandibular first premolar", "code": "44,34" },
		  { "fdiName": "maxillary second premolar", "code": "15,25" },
		  { "fdiName": "mandibular second premolar", "code": "45,35" },
		  { "fdiName": "maxillary first molar", "code": "16,26,54,64" },
		  { "fdiName": "mandibular first molar", "code": "46,36,84,74" },
		  { "fdiName": "maxillary second molar", "code": "17,27,55,65" },
		  { "fdiName": "mandibular second molar", "code": "47,37,85,75" },
		  { "fdiName": "maxillary third molar", "code": "18,28" },
		  { "fdiName": "mandibular third molar", "code": "48,38" }
		];
			 var found = findItem(objGroup, params.getVal);

			function findItem(array, value) {
					for (var i = 0; i < array.length; i++) {
						if (array[i].code.split(',').indexOf(value) >= 0) {
						   return objGroup[i];
					}
				}
			}
			$(".toothname").text(found.fdiName);
			$(".toothnum").text(params.getVal);
